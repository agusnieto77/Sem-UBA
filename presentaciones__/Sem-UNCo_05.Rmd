...
subtitle: "<span style='font-size: 48px; color: darkred;'><br>Herramientas computacionales para el análisis de la conflictividad en la era del Big Data</span><br><span style='font-size: 38px;'>Web Scraping IV</span>"
