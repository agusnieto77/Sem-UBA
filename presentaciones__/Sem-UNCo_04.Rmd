---
title: '<span style="color: skyblue"><b>La Sociología y el giro digital</b></span>'

subtitle: "<span style='font-size: 48px; color: darkred;'><br>Herramientas computacionales para el análisis de la conflictividad en la era del Big Data</span><br><span style='font-size: 38px;'>Web Scraping III</span>"
...
body {
  background-image: 
  url(D:/Google_Drive_ok/R/GITHUB/Sem-UNComa/images/fadecs.png),
  url(D:/Google_Drive_ok/R/GITHUB/Sem-UNComa/images/fadecs.png), 
  url(D:/Google_Drive_ok/R/GITHUB/Sem-UNComa/images/fadecs.png), 
  url(D:/Google_Drive_ok/R/GITHUB/Sem-UNComa/images/fadecs.png);
  background-size: 32%, 32%, 32%, 32%;
  background-repeat: no-repeat, no-repeat, no-repeat, no-repeat;
  background-position: 97% 95%, 97% 3%, 3% 3%, 3% 95%;
}
...
![](../../ryrstudio/img/URL.png){width=50%}
</div>
...
![](../../ryrstudio/img/for.png){width=50%}
</div>
